...
## V11 QA additions
- [x] حذف صور المنتج من واجهة التعديل قبل الحفظ
- [x] اختيار الصور على دفعات متعددة في صفحة الإضافة/التعديل
- [x] توحيد قيمة السعر المجاني إلى `مجاني` لتفادي فشل قواعد Firestore
- [x] المنتج المجاني لا يحتاج صفحة دفع، ويُسجل في `free_purchases`
- [x] عدم محاولة تحويل ملف كبير إلى Data URL عند غياب Cloud Storage
- [x] ظهور لوحة البائع عبر رابط عام في الواجهات التي تحتوي شريط تنقل
- [ ] ربط بوابة دفع حقيقية والتحقق من الدفع من الخادم
- [ ] تفعيل App Check
